...
import { validateImage, validateImagePartial, } from "../data_types/validation.js";
...
router.post("/", async (req, res) => {
    ...
    if (objectLink !== "") {
        const addedObjectLink = await addImageLink(objectLink, imageAttempt.insertedId.toString());
